    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a1a] to-[#1a1a3e]">
        ...
        <main className="ml-64 pt-14 min-h-screen flex items-center justify-center">
          <p className="text-white">Войдите для просмотра своих видео</p>
        </main>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a1a] to-[#1a1a3e]">
      ...
      <main className="ml-64 pt-14 min-h-screen">
        <div className="max-w-7xl mx-auto p-6">
          <h1 className="text-3xl font-bold text-white mb-6">Мои видео</h1>
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-400 mb-4">У вас пока нет видео</p>
              <a
                href="/upload"
